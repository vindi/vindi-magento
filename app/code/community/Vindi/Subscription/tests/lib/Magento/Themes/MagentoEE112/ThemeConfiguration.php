...
namespace Magium\Magento\Themes\MagentoEE112;
...
class ThemeConfiguration extends AbstractThemeConfiguration
{
    ...
    const THEME = 'Magium\Magento\Themes\MagentoEE112\ThemeConfiguration';
...
//        [\Magium\WebDriver\WebDriver::INSTRUCTION_MOUSE_CLICK, '//div[@class="minicart-actions"]/descendant::a[@title="Checkout"]']
    ...
    {
        return 'Magium\Magento\Themes\MagentoEE112\Customer\ThemeConfiguration';
    }

    public function getCheckoutThemeClass()
    {
        return 'Magium\Magento\Themes\MagentoEE112\OnePageCheckout\ThemeConfiguration';
    }
