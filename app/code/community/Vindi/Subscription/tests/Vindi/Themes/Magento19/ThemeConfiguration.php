...
namespace Vindi\Themes\Magento19;
...
class ThemeConfiguration extends AbstractThemeConfiguration
{
    ...
    const THEME = 'Vindi\Themes\Magento19\ThemeConfiguration';
     ...
     */
    public $navigationBaseXPathSelector          = '//nav[@id="nav"]';
    ...
    public $categoryAddToCartButtonXPathSelector = '//button[@title="{{Add to Cart}}" and @onclick]';
    ...
    public $baseUrl                      = 'https://vindi.local/';
    ...
    {
        return 'Vindi\Themes\Magento19\Customer\ThemeConfiguration';
    }

    public function getCheckoutThemeClass()
    {
        return 'Vindi\Themes\Magento19\OnePageCheckout\ThemeConfiguration';
    }
