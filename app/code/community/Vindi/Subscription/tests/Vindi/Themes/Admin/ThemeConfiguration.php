...
namespace Vindi\Themes\Admin;

use Magium\AbstractConfigurableElement;
use Magium\AbstractTestCase;
use Vindi\Themes\NavigableThemeInterface;

class ThemeConfiguration extends AbstractConfigurableElement implements  NavigableThemeInterface
{

    const THEME = 'Vindi\Themes\Admin\ThemeConfiguration';

    public $baseUrl = 'https://vindi.local/admin';
