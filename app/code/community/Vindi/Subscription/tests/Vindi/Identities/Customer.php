...
class Customer extends AbstractEntity implements GeneratorAware, NameInterface, EmailInterface, AddressInterface
{
    ...
    public $emailAddress          = 'comunidade@vindi.com.br';

    public $billingFirstName        = 'Vindi';
    public $billingLastName         = 'Recorrência';
    public $billingCompany          = '';
    public $billingAddress          = 'Rua Sena Madureira, 163';
    public $billingAddress2         = '';
    public $billingCity             = 'São Paulo';
    public $billingRegionId         = 'Alabama';
    public $billingPostCode         = '04031-050';
    public $billingCountryId        = 'US';
    public $billingTelephone        = '1159047380';
    public $billingFax              = '';

    public $shippingFirstName        = 'Vindi';
    public $shippingLastName         = 'Recorrência';
    public $shippingCompany          = '';
    public $shippingAddress          = 'Rua Sena Madureira, 163';
    public $shippingAddress2         = '';
    public $shippingCity             = 'São Paulo';
    public $shippingRegionId         = 'Alabama';
    public $shippingPostCode         = '04031-050';
    public $shippingCountryId        = 'US';
    public $shippingTelephone        = '1159047380';
    public $shippingFax              = '';
