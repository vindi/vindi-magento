...
use Vindi\Extractors\Catalog\Products\ProductGrid;
use Vindi\Extractors\Catalog\Products\ProductList;
...
class ListProductsInCategoryTest extends AbstractMagentoTestCase
{
    ...
    protected function extractProducts(array $products)
    {
        foreach ($products as $product) {
            /* @var $product \Vindi\Extractors\Catalog\Products\ProductSummary */
